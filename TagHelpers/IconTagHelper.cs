...
namespace Creator.TagHelpers
{
    ...
    public class IconTagHelper : TagHelperBase
    {
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            base.AddContent(GetTag(), true, ContentPositions.Body);
        ...
        private string GetColorProfile()
        {
            ...
            switch (this.Type)
            {
                ...
                case Symbols.CloseCircleFull:
                    result = CreatorColorProfiles.Danger.ToString();
                    break;
            }
        ...
        private string GetCaption(CaptionTypes type = CaptionTypes.Content)
        {
            ...
            if (this.Text.IsNull())
            {
                switch (this.Type)
                {
                    ...
                    case Symbols.DeleteTrash:
                    case Symbols.DeleteTrashBold:
                    case Symbols.DeleteTrashFull:
                    case Symbols.DeleteMinusCircleFull:
                    case Symbols.DeleteMinus:
                    case Symbols.DeleteMinusSquare:
                    case Symbols.DeleteMinusSquareFull:
                        result = TextDeluxe ? GetTextByLanguage("Trykk for å slette", "Click to delete") : GetTextByLanguage("Slett", "Delete");
                        break;

                    case Symbols.DeleteUser:
                    case Symbols.DeleteUserMinus:
                        result = TextDeluxe ? GetTextByLanguage("Trykk for å slette bruker", "Click to delete user") : GetTextByLanguage("Slett", "Delete");
                        break;
                }
            }
